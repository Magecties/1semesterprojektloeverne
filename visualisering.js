...
d3.json("https://projektspillet-loverne.onrender.com/skraldfarlighed").then(
  function (d) {
    const svg = d3
      .select("body")
      .append("svg")
    ...
    // hover funktion med brug a tooltip
    ...
    // Funktion til at fjerne tooltop
    function handleMouseOut() {
      d3.select("#tooltip").classed("hidden", true);
    }

    // tilsæt mousover og mouseout til cirklerne
    ...
    //Indsæt navn og farver til documentet
