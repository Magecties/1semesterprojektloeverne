d3.json("http://localhost:3000/skrald").then(function (d) {
  ...
  const materials = [
    ...
    {
      name: d.skrald[23].navn,
      image: "/Spilbilleder/Cykel.png",
      nedbrydningstid: d.skrald[23].nedbrydningstid,
      nedbrydningstidværdi: d.skrald[23].nedbrydningstidværdi,
      beskrivelse: d.skrald[23].beskrivelse,
    },
    {
